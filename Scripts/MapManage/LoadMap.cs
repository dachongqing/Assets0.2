...
public class LoadMap : MonoBehaviour {
    ...
    private void genUpMap(Dictionary<int[], int[]> mapUp)
    {
    ...
    private void genGroundMap(Dictionary<int[], int[]> mapGround)
    {
        // Debug.Log("init map begin");
        mapManager = new MapContraller();
        roomManager = GetComponent<RoomContraller>();
    ...
    private void genDownMap(Dictionary<int[],int[]> mapDown)
    {
        // Debug.Log("init map begin");
        mapManager = new MapContraller();
        roomManager = GetComponent<RoomContraller>();
    ...
    void Start()
    {
        string dirpath = Application.persistentDataPath + "/Save/SaveData1.sav";
      
        this.genUpMap(genMap(dirpath));

        dirpath = Application.persistentDataPath + "/Save/SaveData2.sav";
        this.genGroundMap(genMap(dirpath));

        dirpath = Application.persistentDataPath + "/Save/SaveData3.sav";
        this.genDownMap(genMap(dirpath));
    }
